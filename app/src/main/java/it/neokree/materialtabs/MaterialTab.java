...
//                completeView.setBackgroundColor(Color.argb(0x80, Color.red(accentColor), Color.green(accentColor), Color.blue(accentColor)));
                completeView.setBackgroundColor(v.getContext().getResources().getColor(R.color.primary_light));
            }
        ...
        if(event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if(!deviceHaveRippleSupport()) {
                ...
                this.background.reveal(lastTouchedPoint.x, lastTouchedPoint.y, v.getContext().getResources().getColor(
                        org.kidinov.justweight.R.color.primary_light), 0, REVEAL_DURATION, new Animator.AnimatorListener() {
                    @Override
